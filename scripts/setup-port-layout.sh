...
See MULTIPLAYER.md for LAN, Internet (Tailscale/VPS), and run-dedicated.run."

chmod +x "$PORT/run-dedicated.run" "$PORT/helpers/mpserver-entrypoint.run" 2>/dev/null || true
